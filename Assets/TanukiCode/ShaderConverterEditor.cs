...
public class ShaderConverterEditor : EditorWindow
{
	...
	void CreateShader(){
		...
		if (File.Exists (path + fileName)) {
			...
			Replace = EditorUtility.DisplayDialog ("\"" + fileName + "\" already exists. Do you want to replace it?",
				               "A file with the same name already exists in this location. Replacing it will overwrite its contents."
				, "Replace", "Cancel");
